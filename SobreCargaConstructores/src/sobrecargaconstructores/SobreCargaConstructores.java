...
public class SobreCargaConstructores {
    ...
    public static void main(String[] args) {
        //El constructor vacio es privado, por l que nos obliga a utilizar el unico constructor publico
        //y por lo tanto proporcionar valores en los campos de nombre y edad
